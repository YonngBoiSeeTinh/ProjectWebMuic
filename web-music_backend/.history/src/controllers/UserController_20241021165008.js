...
const updateUser = async (req, res) => {
    try {
        ...
        const { name, email, password, confirmPassword, phone, isAdmin,address, avatar, sex, introduce } = req.body;
        ...
        const updatedData = { name, email, phone,password,confirmPassword, isAdmin,address, avatar, sex, introduce };
