...
const updateUser = async (req, res) => {
    try {
        ...
        const { name, email, password, confirmPassword, phone, isAdmin,address, avatar, sex, introduce,birthday } = req.body;
        ...
        const updatedData = { name, email, phone,password,confirmPassword, isAdmin,address, avatar, sex, introduce, birthday };
